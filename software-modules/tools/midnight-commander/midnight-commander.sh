...
#	Script to build the modular software package of Midnight Commander
...
## Install software
apt update
apt install --yes --no-install-recommends mc
apt autoremove --yes
...
rm -rf /tmp/$NAME.hsm/usr/share/applications/mc.desktop
