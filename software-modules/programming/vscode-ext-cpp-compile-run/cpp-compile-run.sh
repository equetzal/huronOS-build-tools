...
EXTENSION_URL="https://github.com/danielpinto8zz6/c-cpp-compile-run/releases/download/v1.0.15/c-cpp-compile-run-1.0.15.vsix"
...
/usr/share/codium/bin/codium --install-extension "$EXTENSION" --extensions-dir "$EXTENSIONS_DIR" --no-sandbox --user-data-dir /tmp/
