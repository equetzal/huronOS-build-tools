...
INST_PACKAGES="acpi-support-base acpid alsa-utils bzip2 connman curl dnsutils dosfstools file hdparm less lsof lzma man ntfs-3g ntpdate pm-utils powermgmt-base psmisc rfkill sdparm squashfs-tools usb-modeswitch wget wireless-tools wpasupplicant xz-utils"
