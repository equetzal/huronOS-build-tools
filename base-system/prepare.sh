...
INST_PACKAGES="acpi-support-base acpid alsa-utils at bzip2 connman curl dbus-broker dnsutils dosfstools file hdparm htop kexec-tools less lsof lzma man ntfs-3g ntpdate oomd parted pm-utils powermgmt-base psmisc rfkill sdparm speedtest-cli squashfs-tools usb-modeswitch wget wireless-tools wpasupplicant xz-utils"
